-- Referenced enums and their values for use in the defined APIs
local SYS_COLOR_INDEX = {
    COLOR_SCROLLBAR = 0x0;
...
local WIN32_ERROR = {
    ...
    ERROR_NOT_A_DEV_VOLUME = 0x1DC;
    ERROR_FS_GUID_MISMATCH = 0x1DD;
    ERROR_CANT_ATTACH_TO_DEV_VOLUME = 0x1DE;
    ERROR_INVALID_CONFIG_VALUE = 0x1DF;
    ...
    ERROR_VOLUME_UPGRADE_NOT_NEEDED = 0x203;
    ERROR_VOLUME_UPGRADE_PENDING = 0x204;
    ERROR_VOLUME_UPGRADE_DISABLED = 0x205;
    ERROR_VOLUME_UPGRADE_DISABLED_TILL_OS_DOWNGRADE_EXPIRED = 0x206;
    ...
    ERROR_SYSTEM_INTEGRITY_REPUTATION_EXPLICIT_DENY_FILE = 0x11E6;
    ...
    ERROR_POLICY_CONTROLLED_ACCOUNT = 0x21CE;
    ERROR_LAPS_LEGACY_SCHEMA_MISSING = 0x21CF;
    ERROR_LAPS_SCHEMA_MISSING = 0x21D0;
    ERROR_LAPS_ENCRYPTION_REQUIRES_2016_DFL = 0x21D1;
    ...
    APPMODEL_ERROR_DYNAMIC_PROPERTY_READ_FAILED = 0x3D58;
    APPMODEL_ERROR_DYNAMIC_PROPERTY_INVALID = 0x3D59;
    APPMODEL_ERROR_PACKAGE_NOT_AVAILABLE = 0x3D5A;
    APPMODEL_ERROR_NO_MUTABLE_DIRECTORY = 0x3D5B;
...
-- Referenced constants and their values for use in the defined APIs
HWND_TOP       = 0;
SWP_NOZORDER   = 0x0004;
SWP_NOACTIVATE = 0x0010;
SWP_SHOWWINDOW = 0x0040;

local CB_MAX_DISK = 0x7FFFFFFF;
local CB_MAX_FILENAME = 0x100;
local CB_MAX_CABINET_NAME = 0x100;
local CB_MAX_CAB_PATH = 0x100;
local CB_MAX_DISK_NAME = 0x100;
local CB_SETMINVISIBLE = 0x1701;
local CB_GETMINVISIBLE = 0x1702;
local CB_SETCUEBANNER = 0x1703;
local CB_GETCUEBANNER = 0x1704;
local WM_CREATE = 0x1;
local WM_DESTROY = 0x2;
local WM_COMMAND = 0x111;
local BS_DEFPUSHBUTTON = 0x1;
local CB_OKAY = 0x0;
local CB_ERR = 0xFFFFFFFF;
local CB_ERRSPACE = 0xFFFFFFFE;
local CBN_SELCHANGE = 0x1;
local CBS_SIMPLE = 0x1;
local CBS_DROPDOWN = 0x2;
local CBS_DROPDOWNLIST = 0x3;
local CBS_OWNERDRAWFIXED = 0x10;
local CBS_OWNERDRAWVARIABLE = 0x20;
local CBS_AUTOHSCROLL = 0x40;
local CBS_OEMCONVERT = 0x80;
local CBS_SORT = 0x100;
local CBS_HASSTRINGS = 0x200;
local CBS_NOINTEGRALHEIGHT = 0x400;
local CBS_DISABLENOSCROLL = 0x800;
local CBS_UPPERCASE = 0x2000;
local CBS_LOWERCASE = 0x4000;
local CB_GETEDITSEL = 0x140;
local CB_LIMITTEXT = 0x141;
local CB_SETEDITSEL = 0x142;
local CB_ADDSTRING = 0x143;
local CB_DELETESTRING = 0x144;
local CB_DIR = 0x145;
local CB_GETCOUNT = 0x146;
local CB_GETCURSEL = 0x147;
local CB_GETLBTEXT = 0x148;
local CB_GETLBTEXTLEN = 0x149;
local CB_INSERTSTRING = 0x14A;
local CB_RESETCONTENT = 0x14B;
local CB_FINDSTRING = 0x14C;
local CB_SELECTSTRING = 0x14D;
local CB_SETCURSEL = 0x14E;
local CB_SHOWDROPDOWN = 0x14F;
local CB_GETITEMDATA = 0x150;
local CB_SETITEMDATA = 0x151;
local CB_GETDROPPEDCONTROLRECT = 0x152;
local CB_SETITEMHEIGHT = 0x153;
local CB_GETITEMHEIGHT = 0x154;
local CB_SETEXTENDEDUI = 0x155;
local CB_GETEXTENDEDUI = 0x156;
local CB_GETDROPPEDSTATE = 0x157;
local CB_FINDSTRINGEXACT = 0x158;
local CB_SETLOCALE = 0x159;
local CB_GETLOCALE = 0x15A;
local CB_GETTOPINDEX = 0x15B;
local CB_SETTOPINDEX = 0x15C;
local CB_GETHORIZONTALEXTENT = 0x15D;
local CB_SETHORIZONTALEXTENT = 0x15E;
local CB_GETDROPPEDWIDTH = 0x15F;
local CB_SETDROPPEDWIDTH = 0x160;
local CB_INITSTORAGE = 0x161;
local CB_MULTIPLEADDSTRING = 0x163;
local CB_GETCOMBOBOXINFO = 0x164;
local CB_MSGMAX = 0x165;
local CW_USEDEFAULT = 0x80000000;

return {
    SYS_COLOR_INDEX = SYS_COLOR_INDEX;
    CB_MAX_DISK = CB_MAX_DISK;
    CB_MAX_FILENAME = CB_MAX_FILENAME;
    CB_MAX_CABINET_NAME = CB_MAX_CABINET_NAME;
    CB_MAX_CAB_PATH = CB_MAX_CAB_PATH;
    CB_MAX_DISK_NAME = CB_MAX_DISK_NAME;
    CB_SETMINVISIBLE = CB_SETMINVISIBLE;
    CB_GETMINVISIBLE = CB_GETMINVISIBLE;
    CB_SETCUEBANNER = CB_SETCUEBANNER;
    CB_GETCUEBANNER = CB_GETCUEBANNER;
    WM_CREATE = WM_CREATE;
    ...
    UInt16_I = UInt16_I;
    UInt32_T = UInt32_T;
    WNDCLASS_STYLES = WNDCLASS_STYLES;
    WNDCLASS_STYLES_T = WNDCLASS_STYLES_T;
    WNDPROC = WNDPROC;
    WNDPROC_T = WNDPROC_T;
    Int32_T = Int32_T;
    ...
    WNDCLASSEXAPtr_I = WNDCLASSEXAPtr_I;
    WINDOW_EX_STYLE = WINDOW_EX_STYLE;
    WINDOW_EX_STYLE_I = WINDOW_EX_STYLE_I;
    WINDOW_STYLE = WINDOW_STYLE;
    WINDOW_STYLE_I = WINDOW_STYLE_I;
    Int32_I = Int32_I;
    HMENU_I = HMENU_I;
    HINSTANCE_I = HINSTANCE_I;
    VoidPtr_I = VoidPtr_I;
    SHOW_WINDOW_CMD = SHOW_WINDOW_CMD;
    SHOW_WINDOW_CMD_I = SHOW_WINDOW_CMD_I;
    HANDLE_I = HANDLE_I;
    WINDOW_LONG_PTR_INDEX = WINDOW_LONG_PTR_INDEX;
    WINDOW_LONG_PTR_INDEX_I = WINDOW_LONG_PTR_INDEX_I;
    HCURSOR_I = HCURSOR_I;
    PSTR_I = PSTR_I;
    --kernel32 = kernel32;
    --user32 = user32;
